      ...
      <div className="flex justify-between">
            ...
            <div key={index} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                {col.sites.map((site, index) => (
                  <a key={index} href="#" className="text-link text-muted hover:text-primary">{site}</a>
                ))}
              </div>
            </div>
          ))}
        ...
        <div>
          ...
          <div className="flex border rounded-md">
            <input type="text" name="" id="" placeholder="Your Email" className="px-5 py-4 rounded-l-md" />
            <button className="px-5 py-4 text-white bg-primary hover:bg-primary/90">
              Subscribe
            </button>
          </div>
          <p className="mt-1 text-link text-muted">Lorem impsum dolor amit</p>
        </div>
      </div>
